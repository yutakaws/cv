...
これまで3年間、AWSを中心としたクラウドインフラの設計・構築を経験してきました。DatadogやPagerDutyを活用した監視システム/SREの構築・検証の経験があり、社内にナレッジがない新しいリソースも率先して調査・検証し、チームに共有してきました。
プロジェクトでは、チームメンバーと協力しながら要件の調整や技術的課題の解決に取り組み、未経験領域の技術でも柔軟に対応できる体制を築いています。
今後は、AWSやSREの知見をさらに深め、インフラ設計・構築の実務力を活かしてプロジェクトに貢献していきたいと考えています。
